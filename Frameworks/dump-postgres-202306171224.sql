...
-- Started on 2023-06-17 12:24:43 -03
...
CREATE ROLE lucasmichalski;
ALTER ROLE lucasmichalski WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN NOREPLICATION NOBYPASSRLS;
...
-- Completed on 2023-06-17 12:24:43 -03
...
--
-- TOC entry 3612 (class 1262 OID 16774)
-- Name: apiPetDogui; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "apiPetDogui" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE "apiPetDogui" OWNER TO postgres;
...
CREATE TABLE public.endereco (
    id integer NOT NULL,
    nome_rua character varying(150),
    complemento character varying(150),
    bairro character varying(150),
    numero_casa integer,
    numero_cep character varying(15),
    st_ativo boolean,
...
--
-- TOC entry 211 (class 1259 OID 17410)
...
--
-- TOC entry 210 (class 1259 OID 17404)
...
--
-- TOC entry 209 (class 1259 OID 17403)
...
--
-- TOC entry 214 (class 1259 OID 17423)
...
--
-- TOC entry 213 (class 1259 OID 17422)
...
--
-- TOC entry 216 (class 1259 OID 17435)
...
--
-- TOC entry 215 (class 1259 OID 17434)
...
--
-- TOC entry 3447 (class 2604 OID 17414)
...
--
-- TOC entry 3446 (class 2604 OID 17407)
...
--
-- TOC entry 3448 (class 2604 OID 17426)
...
--
-- TOC entry 3449 (class 2604 OID 17438)
...
--
-- TOC entry 3602 (class 0 OID 17411)
-- Dependencies: 212
-- Data for Name: endereco; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.endereco (id, nome_rua, complemento, bairro, numero_casa, numero_cep, st_ativo, id_pessoa) FROM stdin;
\.


--
-- TOC entry 3600 (class 0 OID 17404)
-- Dependencies: 210
-- Data for Name: pessoa; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pessoa (id, nome, telefone, email, st_ativo) FROM stdin;
\.


--
-- TOC entry 3604 (class 0 OID 17423)
-- Dependencies: 214
-- Data for Name: pet; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pet (id, nome, id_dono, genero, peso, porte) FROM stdin;
\.


--
-- TOC entry 3606 (class 0 OID 17435)
-- Dependencies: 216
-- Data for Name: servico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.servico (id, descricao, valor, status) FROM stdin;
1	teste	10	t
2	teste	10	t
3	teste	10	t
4	teste	10	t
...
SELECT pg_catalog.setval('public.servico_id_seq', 6, true);


--
-- TOC entry 3453 (class 2606 OID 17416)
...
--
-- TOC entry 3451 (class 2606 OID 17409)
...
--
-- TOC entry 3457 (class 2606 OID 17440)
...
--
-- TOC entry 3458 (class 2606 OID 17417)
-- Name: endereco endereco_id_pessoa_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3459 (class 2606 OID 17429)
-- Name: pet pet_id_dono_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pet
    ADD CONSTRAINT pet_id_dono_fkey FOREIGN KEY (id_dono) REFERENCES public.pessoa(id);
...
--
-- TOC entry 3570 (class 1262 OID 16385)
-- Name: lucasmichalski; Type: DATABASE; Schema: -; Owner: lucasmichalski
--

CREATE DATABASE lucasmichalski WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE lucasmichalski OWNER TO lucasmichalski;

\connect lucasmichalski
...
-- Completed on 2023-06-17 12:24:44 -03
...
-- Started on 2023-06-17 12:24:44 -03
...
-- Name: agendamentoservico; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.agendamentoservico (
    id bigint NOT NULL,
...
ALTER TABLE public.agendamentoservico OWNER TO postgres;

--
-- TOC entry 212 (class 1259 OID 17116)
-- Name: agendamentoservico_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.agendamentoservico_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.agendamentoservico_id_seq OWNER TO postgres;

--
-- TOC entry 3668 (class 0 OID 0)
-- Dependencies: 212
-- Name: agendamentoservico_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.agendamentoservico_id_seq OWNED BY public.agendamentoservico.id;
...
--
-- TOC entry 215 (class 1259 OID 17130)
-- Name: endereco; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 221 (class 1259 OID 17212)
-- Name: pet; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 220 (class 1259 OID 17211)
-- Name: pet_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3476 (class 2604 OID 17943)
...
--
-- TOC entry 3472 (class 2604 OID 17120)
-- Name: agendamentoservico id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agendamentoservico ALTER COLUMN id SET DEFAULT nextval('public.agendamentoservico_id_seq'::regclass);


--
-- TOC entry 3475 (class 2604 OID 17215)
-- Name: pet id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3473 (class 2604 OID 17146)
-- Name: servico id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3474 (class 2604 OID 17158)
...
--
-- TOC entry 3661 (class 0 OID 17940)
-- Dependencies: 224
-- Data for Name: agendamento; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.agendamento (id, datahora, obs, situacao, valor_total, id_pet, id_usuario) FROM stdin;
1	2023-05-19 20:02:00	\N	\N	10.00	1	1
2	2023-05-19 20:00:00	\N	\N	20.00	1	\N
\.


--
-- TOC entry 3650 (class 0 OID 17117)
-- Dependencies: 213
-- Data for Name: agendamentoservico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.agendamentoservico (id, valor_un, id_agendamento, id_servico) FROM stdin;
5	10.00	3	1
6	25.00	3	6
7	15.00	3	4
8	10.00	4	1
...
--
-- TOC entry 3647 (class 0 OID 16724)
-- Dependencies: 210
-- Data for Name: cidade; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cidade (cod_ibge, nome, cod_estado) FROM stdin;
...
--
-- TOC entry 3651 (class 0 OID 17123)
-- Dependencies: 214
-- Data for Name: cliente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cliente (id_cliente, ativo, cpf, email, nome) FROM stdin;
1	t	12345678901	Email@email.com	geraldo
24	t	923840923	sdkmakjsdfkasl@saljlsdkjla	lucas micrhalski
30	f	343897290302	santomel@gmail.com	santomel
\.
...
COPY public.endereco (id_endereco, bairro, cep, logradouro, numero, id_cidade, id_cliente) FROM stdin;
25	jardim europa	89349029	rua da minha casa	238	\N	24
\.


--
-- TOC entry 3648 (class 0 OID 16741)
-- Dependencies: 211
-- Data for Name: estado; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.estado (codigo, nome, sigla) FROM stdin;
11	RONDONIA	RO
12	ACRE	AC
13	AMAZONAS	AM
14	RORAIMA	RR
...
--
-- TOC entry 3658 (class 0 OID 17212)
-- Dependencies: 221
-- Data for Name: pet; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.pet (id, nome, obs, sexo, tamanho, id_cliente) FROM stdin;
1	klebin	nada nao	MACHO	PEQUENO	1
2	jubliscleiton	nada	MACHO	MINI	1
3	matiollo		MACHO	MINI	24
\.


--
-- TOC entry 3654 (class 0 OID 17143)
-- Dependencies: 217
-- Data for Name: servico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.servico (id, descricao, valor) FROM stdin;
1	TOSA	10.00
2	BANHO	10.00
3	VACINA	20.00
4	ENFEITE	15.00
...
--
-- TOC entry 3659 (class 0 OID 17221)
-- Dependencies: 222
-- Data for Name: telefone; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.telefone (id_telefone, telefone, tipo, id_cliente) FROM stdin;
\.


--
-- TOC entry 3656 (class 0 OID 17155)
-- Dependencies: 219
...
-- Dependencies: 212
-- Name: agendamentoservico_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.agendamentoservico_id_seq', 10, true);
...
--
-- TOC entry 3498 (class 2606 OID 17945)
...
--
-- TOC entry 3482 (class 2606 OID 17122)
-- Name: agendamentoservico agendamentoservico_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.agendamentoservico
    ADD CONSTRAINT agendamentoservico_pkey PRIMARY KEY (id);


--
-- TOC entry 3478 (class 2606 OID 16728)
...
--
-- TOC entry 3484 (class 2606 OID 17129)
...
--
-- TOC entry 3488 (class 2606 OID 17134)
-- Name: endereco endereco_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3480 (class 2606 OID 16745)
...
--
-- TOC entry 3494 (class 2606 OID 17219)
-- Name: pet pet_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3490 (class 2606 OID 17148)
-- Name: servico servico_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3496 (class 2606 OID 17225)
...
--
-- TOC entry 3486 (class 2606 OID 17162)
-- Name: cliente uk_62uiuvr9jpnkok8sve9l23dvg; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3492 (class 2606 OID 17160)
...
--
-- TOC entry 3504 (class 2606 OID 17247)
-- Name: telefone fk5frmo7myox79wtk9msfhh4w8m; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.telefone
    ADD CONSTRAINT fk5frmo7myox79wtk9msfhh4w8m FOREIGN KEY (id_cliente) REFERENCES public.cliente(id_cliente);


--
-- TOC entry 3506 (class 2606 OID 17955)
-- Name: agendamento fk6fsrijsknwk5ebbpq4ij0u1xw; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: agendamentoservico fk8jbxvfjdnnd25r5uuln3isnwl; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3503 (class 2606 OID 17242)
-- Name: pet fk92cyr4va8b9x2madre83mpvkh; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pet
    ADD CONSTRAINT fk92cyr4va8b9x2madre83mpvkh FOREIGN KEY (id_cliente) REFERENCES public.cliente(id_cliente);


--
-- TOC entry 3501 (class 2606 OID 17183)
-- Name: endereco fk9kfv2ojnna0ywwe0t601f1kn; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3502 (class 2606 OID 17188)
-- Name: endereco fkblowj6gkb8nfh9i07j6koml33; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.endereco
    ADD CONSTRAINT fkblowj6gkb8nfh9i07j6koml33 FOREIGN KEY (id_cliente) REFERENCES public.cliente(id_cliente);


--
-- TOC entry 3505 (class 2606 OID 17950)
-- Name: agendamento fkp54qpvfkc8dr4qh2r2ckp1ykw; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3499 (class 2606 OID 16755)
-- Name: cidade fkqbnh7ry4uxdjrhakpons3jct5; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3635 (class 1262 OID 16386)
-- Name: revisaoBanco; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "revisaoBanco" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';


ALTER DATABASE "revisaoBanco" OWNER TO postgres;

\connect "revisaoBanco"
...
-- Name: fornecedor_produto; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.fornecedor_produto OWNER TO postgres;
...
CREATE TABLE public.venda (
    id integer NOT NULL,
    formapgto character varying(20),
    total money,
    desconto money,
    datacadastro timestamp without time zone,
    vendedor_id integer,
...
--
-- TOC entry 3460 (class 2604 OID 16410)
...
--
-- TOC entry 3461 (class 2604 OID 16417)
...
--
-- TOC entry 3458 (class 2604 OID 16396)
...
--
-- TOC entry 3624 (class 0 OID 16407)
-- Dependencies: 214
-- Data for Name: cliente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cliente (id, codigo, nome, endereco, documento, datacadastro) FROM stdin;
\.


--
-- TOC entry 3626 (class 0 OID 16414)
-- Dependencies: 216
-- Data for Name: fornecedor; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.fornecedor (id, codigo, nome, endereco, documento, datacadastro) FROM stdin;
1	0012	abreu aguas	rua	35.648.155/0001-13	2023-03-02 21:58:18.22903
2	0013	klebin do vinho	rua	45.648.155/0001-13	2023-03-02 21:58:18.22903
3	0014	matias do whisky	rua	55.648.155/0001-13	2023-03-02 21:58:18.22903
4	0015	zezao da cerva	rua	65.648.155/0001-13	2023-03-02 21:58:18.22903
5	0016	jonas agua	rua	75.648.155/0001-13	2023-03-02 21:58:18.22903
6	0017	batista refris	rua	85.648.155/0001-13	2023-03-02 21:58:18.22903
7	0018	moreno conveniencia	rua	95.648.155/0001-13	2023-03-02 21:58:18.22903
8	0019	ticorico aguas	rua	05.648.155/0001-13	2023-03-02 21:58:18.22903
\.


--
-- TOC entry 3627 (class 0 OID 16420)
-- Dependencies: 217
-- Data for Name: fornecedor_produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.fornecedor_produto (produto_id, fornecedor_id) FROM stdin;
1	1
3	1
1	2
1	3
...
--
-- TOC entry 3629 (class 0 OID 16448)
-- Dependencies: 219
-- Data for Name: itemvenda; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.itemvenda (id, qtd, valorun, valortotal, desconto, datacadastro, produto_id, venda_id) FROM stdin;
\.


--
-- TOC entry 3620 (class 0 OID 16393)
-- Dependencies: 210
-- Data for Name: produto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.produto (id, descricao, un, valor, datacadastro, codigo) FROM stdin;
1	AGUA	UN	$2.99	2023-03-02 20:29:33.12919	02X5
3	REFRIGERANTE	UN	$3.99	2023-03-02 20:35:31.777297	04X5
4	CERVEJA	UN	$5.99	2023-03-02 20:35:31.777297	05X5
5	SUCO	UN	$1.99	2023-03-02 20:35:31.777297	06X5
6	VINHO	UN	$32.99	2023-03-02 20:35:31.777297	07X5
\.


--
-- TOC entry 3628 (class 0 OID 16433)
-- Dependencies: 218
-- Data for Name: venda; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.venda (id, formapgto, total, desconto, datacadastro, vendedor_id, cliente_id) FROM stdin;
\.
...
COPY public.vendedor (id, codigo, nome, porcentagemdesconto, datacadastro) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.fornecedor_id_seq', 8, true);
...
--
-- TOC entry 3467 (class 2606 OID 16412)
-- Name: cliente cliente_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3473 (class 2606 OID 16452)
...
--
-- TOC entry 3463 (class 2606 OID 16398)
...
--
-- TOC entry 3471 (class 2606 OID 16437)
...
--
-- TOC entry 3465 (class 2606 OID 16405)
...
--
-- TOC entry 3475 (class 2606 OID 16463)
-- Name: fornecedor_produto fornecedor_produto_fornecedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fornecedor_produto
    ADD CONSTRAINT fornecedor_produto_fornecedor_id_fkey FOREIGN KEY (fornecedor_id) REFERENCES public.fornecedor(id);


--
-- TOC entry 3474 (class 2606 OID 16428)
-- Name: fornecedor_produto fornecedor_produto_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fornecedor_produto
    ADD CONSTRAINT fornecedor_produto_produto_id_fkey FOREIGN KEY (produto_id) REFERENCES public.produto(id);


--
-- TOC entry 3478 (class 2606 OID 16453)
-- Name: itemvenda itemvenda_produto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.itemvenda
    ADD CONSTRAINT itemvenda_produto_id_fkey FOREIGN KEY (produto_id) REFERENCES public.produto(id);


--
-- TOC entry 3479 (class 2606 OID 16458)
-- Name: itemvenda itemvenda_venda_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.itemvenda
    ADD CONSTRAINT itemvenda_venda_id_fkey FOREIGN KEY (venda_id) REFERENCES public.venda(id);


--
-- TOC entry 3477 (class 2606 OID 16443)
...
ALTER TABLE ONLY public.venda
    ADD CONSTRAINT venda_vendedor_id_fkey FOREIGN KEY (vendedor_id) REFERENCES public.vendedor(id);
...
--
-- TOC entry 3619 (class 1262 OID 17812)
-- Name: spring; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE spring WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.UTF-8';
...
--
-- TOC entry 210 (class 1259 OID 18185)
...
CREATE TABLE public.consulta (
    ...
    motivo_cancelamento character varying(100),
    medico_id bigint,
    paciente_id bigint
);
...
--
-- TOC entry 209 (class 1259 OID 18184)
...
--
-- TOC entry 212 (class 1259 OID 18191)
-- Name: endereco; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 211 (class 1259 OID 18190)
-- Name: endereco_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 214 (class 1259 OID 18197)
...
--
-- TOC entry 213 (class 1259 OID 18196)
...
--
-- TOC entry 215 (class 1259 OID 18202)
...
CREATE TABLE public.usuario (
    ...
    usuario_ad character varying(100) NOT NULL
);
...
--
-- TOC entry 217 (class 1259 OID 18208)
-- Name: usuario_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3605 (class 0 OID 18185)
-- Dependencies: 210
-- Data for Name: consulta; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.consulta (id, data_hora, motivo_cancelamento, medico_id, paciente_id) FROM stdin;
\.


--
-- TOC entry 3607 (class 0 OID 18191)
-- Dependencies: 212
-- Data for Name: endereco; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.endereco (id, bairro, cep, cidade, complemento, logradouro, numero, uf) FROM stdin;
1	jardim europa	85908120	Toledo	Casa	rua Carlos gomes	546	PR
2	jardim europa	85908120	Toledo	Casa	rua Carlos gomes	546	PR
3	jardim europa	85908120	Toledo	Casa	rua Carlos gomes	546	PR
4	jardim europa	85908120	Toledo	Casa	rua Carlos gomes	546	PR
\.


--
-- TOC entry 3609 (class 0 OID 18197)
-- Dependencies: 214
-- Data for Name: medico; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.medico (id, ativo, crm, email, especialidade, nome, telefone, endereco_id) FROM stdin;
\.


--
-- TOC entry 3611 (class 0 OID 18203)
-- Dependencies: 216
-- Data for Name: paciente; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.paciente (id, ativo, cpf, email, nome, telefone, endereco_id) FROM stdin;
\.


--
-- TOC entry 3613 (class 0 OID 18209)
-- Dependencies: 218
-- Data for Name: usuario; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.usuario (id, nome, senha, usuario_ad) FROM stdin;
\.
...
--
-- TOC entry 3452 (class 2606 OID 18189)
...
--
-- TOC entry 3454 (class 2606 OID 18195)
-- Name: endereco endereco_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3456 (class 2606 OID 18201)
...
--
-- TOC entry 3458 (class 2606 OID 18207)
...
--
-- TOC entry 3460 (class 2606 OID 18213)
-- Name: usuario usuario_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3462 (class 2606 OID 18219)
-- Name: consulta fk1oq22nlbbvpijm5n2t6vqi1is; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3463 (class 2606 OID 18224)
-- Name: medico fkdou0400stdgqmwjnsbwd09oy7; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.medico
    ADD CONSTRAINT fkdou0400stdgqmwjnsbwd09oy7 FOREIGN KEY (endereco_id) REFERENCES public.endereco(id);


--
-- TOC entry 3464 (class 2606 OID 18229)
...
--
-- TOC entry 3461 (class 2606 OID 18214)
-- Name: consulta fkskwvuuev2optdrjsfeo1pqo83; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.consulta
    ADD CONSTRAINT fkskwvuuev2optdrjsfeo1pqo83 FOREIGN KEY (medico_id) REFERENCES public.medico(id);
