...
import br.com.unipar.forcavendas.PedidoActivity;
...
public class ItemAdapter extends BaseAdapter {
    ...
    public ItemAdapter(Context context, ArrayList<ItemPedidoVenda> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_lista_item, parent, false);
        }
