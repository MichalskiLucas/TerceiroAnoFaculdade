...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE ITEM(CODIGO INTEGER, DESCRICAO VARCHAR(100), VLUNIT DOUBLE, UNMEDIDA VARCHAR(3))");
        sqLiteDatabase.execSQL("CREATE TABLE PEDIDOVENDA(CODIGO INTEGER, VALORTOTAL DOUBLE, TPAGAMENTO VARCHAR(1), NRPARCELAS INTEGER, CODENDERECOENTREGA INTEGER)");
