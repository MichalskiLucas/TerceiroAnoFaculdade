...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE ITEMPEDIDOVENDA(CODIGO INTEGER, CODIGOPEDIDO INTEGER, CODIGOITEM INTEGER, QTITEM INTEGER, VlUNITITEM DOUBLE, DESCITEM VARCHAR(100))");
    }
